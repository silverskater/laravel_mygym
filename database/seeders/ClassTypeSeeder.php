...
class ClassTypeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $classTypes = [
            ...
            ['name' => 'Les Mills™', 'description' => 'A high-energy workout that combines various fitness disciplines.', 'duration' => 60, 'capacity' => 25, 'color' => '#36A2EB'],
            ['name' => 'Meditation', 'description' => 'A calming class focused on mindfulness and relaxation.', 'duration' => 30, 'capacity' => 15, 'color' => '#FFCD56'],
            ['name' => 'Mobility Training', 'description' => 'A class that focuses on improving joint mobility and flexibility.', 'duration' => 45, 'capacity' => 15, 'color' => '#4BC0C0'],
            ...
            ['name' => 'Stretch and Flexibility', 'description' => 'A class that focuses on improving flexibility and range of motion.', 'duration' => 45, 'capacity' => 15, 'color' => '#9966FF'],
            ['name' => 'T25', 'description' => 'A high-intensity workout that can be done in 25 minutes.', 'duration' => 25, 'capacity' => 20, 'color' => '#FF9F40'],
            ['name' => 'Tabata', 'description' => 'A high-intensity interval training class with short bursts of exercise.', 'duration' => 30, 'capacity' => 25, 'color' => '#FF6384'],
            ['name' => 'Tai Boot', 'description' => 'A fusion of Tai Chi and bootcamp-style training for strength and balance.', 'duration' => 60, 'capacity' => 15, 'color' => '#FFCD56'],
